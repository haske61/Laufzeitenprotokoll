...
<div class="container">
    <div class="mb-4">
        <h1>{{ __('New Bean Delivery') }}</h1>
    </div>

    <div class="card">
        <div class="card-body">
            <form action="{{ route('bean-deliveries.store') }}" method="POST">
                @csrf
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('origin_country') is-invalid @enderror" id="origin_country" name="origin_country" value="{{ old('origin_country') }}">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('bean_type') is-invalid @enderror" id="bean_type" name="bean_type" value="{{ old('bean_type') }}">
                        @error('bean_type')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" step="0.01" class="form-control @error('quantity_kg') is-invalid @enderror" id="quantity_kg" name="quantity_kg" value="{{ old('quantity_kg') }}">
                        @error('quantity_kg')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <input type="number" step="0.01" class="form-control @error('moisture_percentage') is-invalid @enderror" id="moisture_percentage" name="moisture_percentage" value="{{ old('moisture_percentage') }}">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" step="0.01" class="form-control @error('fat_content_percentage') is-invalid @enderror" id="fat_content_percentage" name="fat_content_percentage" value="{{ old('fat_content_percentage') }}">
                    ...
                    <div class="col-md-4">
                        ...
                        <select class="form-select @error('quality_grade') is-invalid @enderror" id="quality_grade" name="quality_grade">
                            ...
                            <option value="D" {{ old('quality_grade') === 'D' ? 'selected' : '' }}>D</option>
                        </select>
                        @error('quality_grade')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="d-flex gap-2">
                    <button type="submit" class="btn btn-primary">{{ __('Save Delivery') }}</button>
                    <a href="{{ route('bean-deliveries.index') }}" class="btn btn-secondary">{{ __('Cancel') }}</a>
                </div>
            </form>
        </div>
    </div>
