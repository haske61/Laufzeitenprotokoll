            ...
            <form method="POST" action="{{ route('production-logs.store') }}">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="datetime-local" name="started_at" id="started_at" class="form-control @error('started_at') is-invalid @enderror" value="{{ old('started_at') }}" required>
                        @error('started_at')
                            <div class="text-danger small mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="number" step="0.01" name="input_quantity_kg" id="input_quantity_kg" class="form-control @error('input_quantity_kg') is-invalid @enderror" value="{{ old('input_quantity_kg') }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" step="0.01" name="output_quantity_kg" id="output_quantity_kg" class="form-control @error('output_quantity_kg') is-invalid @enderror" value="{{ old('output_quantity_kg') }}">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" step="0.1" name="humidity" id="humidity" class="form-control @error('humidity') is-invalid @enderror" value="{{ old('humidity') }}">
                        @error('humidity')
                            <div class="text-danger small mt-1">{{ $message }}</div>
                        @enderror
                    </div>
